...
import allSelectors from '../scripts/allSelectors.js';
...
popupEdit.addEventListener("click", (evt) => {
  if (
    evt.target.classList.contains("popup-edit__close-btn") ||
    evt.target.classList.contains("overlay-edit")
  ) {
...
popupAdd.addEventListener("click", (evt) => {
  if (
    evt.target.classList.contains("popup-add__close-btn") ||
    evt.target.classList.contains("overlay-add")
  ) {
    closePopup(popupAdd);
  }
});
...
popupImage.addEventListener("click", (evt) => {
  if (
    evt.target.classList.contains("popup-img__close-btn") ||
    evt.target.classList.contains("overlay-img")
  ) {
...
const formValidator = new FormValidation(
  allSelectors.formSelectorEdit,
  allSelectors
);
formValidator.enableValidation();

const formValidatorAddImg = new FormValidation(
  allSelectors.formSelectorAddImg,
  allSelectors
);
